...
#client.containers.run('functions/figlet', 'name=kalyan-figlet')
with open('/root/kalyan-thesis/sample.txt','r') as file:
    sampleStr = file.read()
...
i = 1
while i <= 100:
    os.system("docker exec kalyan-figlet figlet %s"%sampleStr)
